            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 md:gap-6 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-border text-foreground placeholder-muted-foreground focus:border-primary/50 focus:outline-none hover:border-primary/50 transition-all"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-border text-foreground placeholder-muted-foreground focus:border-primary/50 focus:outline-none hover:border-primary/50 transition-all resize-none"
                />
              </div>
              <button
                type="submit"
