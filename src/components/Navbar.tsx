...
const MinimalNavbar = () => {
    ...
    const NavIcon = ({ item, isMobile = false }: any) => {
    ...
    return (
        <>
            ...
            <ThemeToggle />
            <nav
                className={`fixed right-4 md:right-6 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col space-y-4 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full'
                    }`}
            >
            ...
            <div className="lg:hidden">
                ...
                <button
                    ...
                    className={`fixed top-4 md:top-6 right-4 md:right-6 z-50 w-12 h-12 rounded-full flex items-center justify-center backdrop-blur-sm border transition-all duration-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full'
                        } ${themeStyles.bg} ${themeStyles.border}`}
                >
                ...
                <div
                    ...
                    className={`fixed inset-0 bg-black/10 backdrop-blur-sm z-30 transition-opacity duration-300 ${isMobileOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
                        }`}
                />
            </div>
        </>
