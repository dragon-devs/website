          ...
          <div className="grid grid-cols-1 gap-4 ">
            {highlights.map((item, index) => (
              ...
              >
                ...
                <span className="text-foreground/80 md:text-4xl text-2xl font-medium tracking-tight md:px-6 p-4 leading-none">{item.text}</span>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="border border-border p-12">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                to excellence. Being small means we're nimble, focused, and personally invested in every project we take on.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
